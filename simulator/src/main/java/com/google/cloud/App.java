...
public class App {
  ...
  @Parameter(names = { "--seed" }, description = "Seed for random number generator (if deterministic)")
  private long seed = 0;
  @Parameter(names = { "--degree" }, description = "Degree for distribution of frequency of orders (0 is uniforn, 1 is linear, 2 for ^2, etc)")
  ...
  @Parameter(names = { "--simtime" }, description = "Use simulated time rather than real time (requires rate for events per second)")
  private long simtime = 0;
  @Parameter(names = { "--duration" }, description = "Duration of the exchange before finishing (format in ISO-8601, e.g., PT2M for 2 minutes")
